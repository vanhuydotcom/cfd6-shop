...
import { ADD_ADDRESS, ADD_WISHLIST, CHANGE_DEFAULT_ADDRESS, DEFAULT_ADDRESS, GET_ADDRESS, REMOVE_ADDRESS, CARD_TYPE, ADD_PAYMENT, GET_PAYMENT, REMOVE_PAYMENT, CHANGE_DEFAULT_PAYMENT, ERR, GET_WISHLIST, REMOVE_WISHLIST } from "../type";
