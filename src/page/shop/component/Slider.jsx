export default function Slider() {
    return (
        <div className="flickity-page-dots-inner mb-9 flickity-enabled is-draggable" data-flickity="{&quot;pageDots&quot;: true}" tabIndex={0}>
            {/* Item */}
            {/* Item */}
            {/* Item */}
            <div className="flickity-viewport" style={{ height: '400px', touchAction: 'pan-y' }}><div className="flickity-slider" style={{ left: '0px', transform: 'translateX(-300%)' }}><div className="w-100 is-selected" style={{ position: 'absolute', left: '300%' }}>
            ...
            </div><div className="w-100" aria-hidden="true" style={{ position: 'absolute', left: '100%' }}>
