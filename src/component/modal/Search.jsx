                        ...
                        <div className="modal-body border-top font-size-sm">
                            ...
                            <div className="row align-items-center position-relative mb-5">
                                ...
                                <div className="col position-static">
                                    ...
                                    <p className="mb-0 font-weight-bold">
                                        <a className="stretched-link text-body" href="./product.html">{t('Leather mid-heel Sandals')}</a> <br />
                            ...
                            <div className="row align-items-center position-relative mb-5">
                                ...
                                <div className="col position-static">
                                    {/* Text */}
                                    <p className="mb-0 font-weight-bold">
                                        <a className="stretched-link text-body" href="./product.html">{t('Cotton floral print Dress')}</a> <br />
